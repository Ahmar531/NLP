...
def create_workflow_graph():
    ...
    graph_builder.add_node("response_behavior_node", response_behavior_node)
    ...
    # conversation_node → response_behavior_node → summarization check
    graph_builder.add_edge("conversation_node", "response_behavior_node")
    graph_builder.add_conditional_edges(
        "response_behavior_node", should_summarize_conversation
    )

    # image_node and audio_node bypass behaviour node (unchanged flow)
